---
title: "DeepSeek-V3.1 — Model Overview"
type: model-note
year: 2025
...
# DeepSeek-V3.1 — Model Overview

> [!tldr]
> hybrid inference 与 agent/tool-use 后训练。
...
- 时间：**2025-08**
- Atlas 归类：**主干正代**
- 一手证据：[Official docs](https://api-docs.deepseek.com/news/news250821/)
