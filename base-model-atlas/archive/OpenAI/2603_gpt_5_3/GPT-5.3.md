...
> [!tldr]
> ChatGPT Instant 正代更新，官方模型目录保留独立 GPT-5.3 Chat 页面。
...
- 时间：**2026-03**
- Atlas 归类：**主干正代**
- 一手证据：[Official docs](https://developers.openai.com/api/docs/models/gpt-5.3-chat-latest)
...
- [https://developers.openai.com/api/docs/models/gpt-5.3-chat-latest](https://developers.openai.com/api/docs/models/gpt-5.3-chat-latest)
