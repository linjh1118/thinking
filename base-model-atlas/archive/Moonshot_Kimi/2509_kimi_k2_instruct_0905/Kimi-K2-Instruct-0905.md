---
title: "Kimi K2-Instruct-0905 — Model Overview"
type: model-note
year: 2025
...
# Kimi K2-Instruct-0905 — Model Overview

> [!tldr]
> K2 的官方主 checkpoint 更新，提升 agentic coding、前端、上下文与工具任务表现。
...
- 时间：**2025-09**
- Atlas 归类：**主干正代**
- 一手证据：[Official repo / model card](https://huggingface.co/moonshotai/Kimi-K2-Instruct-0905)
...
- [https://huggingface.co/moonshotai/Kimi-K2-Instruct-0905](https://huggingface.co/moonshotai/Kimi-K2-Instruct-0905)
