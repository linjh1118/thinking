...
# ChatGLM — Model Overview

> [!tldr]
> 首代中英双语对话 GLM，6.2B 参数，是 ChatGLM 系列公开演进的起点。
...
- 时间：**2023-03**
- Atlas 归类：**主干正代**
- 一手证据：[Official repo / model card](https://github.com/zai-org/ChatGLM-6B)
