...
# ChatGLM2 — Model Overview

> [!tldr]
> 第二代 ChatGLM，以 1.4T 双语 tokens、32K context 和 MQA 改善能力与推理效率。
...
- 时间：**2023-06**
- Atlas 归类：**主干正代**
- 一手证据：[Official repo / model card](https://github.com/zai-org/ChatGLM2-6B)
