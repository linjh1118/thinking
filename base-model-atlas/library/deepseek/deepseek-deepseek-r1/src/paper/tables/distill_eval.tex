\begin{table}[h]
    ...
    \captionof{table}{Comparison of DeepSeek-R1 distilled models and other comparable models on reasoning-related benchmarks. Numbers in bold denote the performance is statistically significant  (t$-$test with $p < 0.01$).}
    \label{tab:distill}
        \begin{tabularx}{\textwidth}{@{}l *{6}{c}@{}}
        \toprule
        \multirow{3}{*}{\centering\textbf{Model}} & \multicolumn{2}{c}{\multirow{2}{*}{\textbf{\footnotesize{AIME 2024}}}} & \multirow{2}{*}{\textbf{\footnotesize{MATH}}} & \textbf{\footnotesize{GPQA}} & \textbf{\footnotesize{LiveCode}} & \multirow{2}{*}{\footnotesize{\textbf{CodeForces}}} \\
        ...
        \textbf{DeepSeek-R1-Distill-Llama-70B} & 70.0 & \textbf{86.7} & \textbf{94.5} & \textbf{65.2} & \textbf{57.5} & \textbf{1633} \\
        \bottomrule
    \end{tabularx}
\end{table}