---
title: "DeepSeek-V2 — Model Overview"
type: model-note
year: 2024
...
# DeepSeek-V2 — Model Overview

> [!tldr]
> MLA + DeepSeekMoE 显著降低训练/推理成本。
...
- 时间：**2024-05**
- Atlas 归类：**主干正代**
- 一手证据：[Official repo / model card](https://github.com/deepseek-ai/DeepSeek-V2)
