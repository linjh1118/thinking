...
**Note: DeepSeek-V4-Pro-DSpark** is **not** a new model. It is the same checkpoint with an additional speculative decoding module attached. A minimal inference example is available in the [`inference`](inference/README.md) folder. For more details, refer to: https://github.com/deepseek-ai/DeepSpec
...
See the [vLLM recipe](https://recipes.vllm.ai/deepseek-ai/DeepSeek-V4-Pro?hardware=b300&features=tool_calling,reasoning) for detailed instructions and other hardware configurations.
