...
# Qwen3.7 — Model Overview

> [!tldr]
> 沿用 hybrid attention 架构并继续推进正代能力。
...
- 时间：**2026-06**
- Atlas 归类：**主干正代**
- 一手证据：[Official repo / model card](https://github.com/QwenLM/Qwen3.8-Flash-Next)
...
- [https://github.com/QwenLM/Qwen3.8-Flash-Next](https://github.com/QwenLM/Qwen3.8-Flash-Next)
