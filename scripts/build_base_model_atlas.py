...
TEAMS = [
    {"id":"openai","dir":"OpenAI","name":"OpenAI · GPT","region":"海外","color":"#7cf2c8","thesis":"从通用 next-token scaling 走向统一 reasoning、工具调用与专业工作基座。","models":[
        ...
        ["260903","GPT-6 Astra","跨浏览器、终端与专业软件的旗舰执行模型，并首次达到 Critical cyber threshold。","https://openai.com/index/gpt-6-astra/"]]},
...
TOP8_MAINLINE_CONTRACT = {
    ...
    "openai": ("GPT-1", "GPT-2", "GPT-3", "GPT-3.5", "GPT-4", "GPT-4 Turbo", "GPT-4o", "GPT-4.5", "GPT-4.1", "GPT-5", "GPT-5.1", "GPT-5.2", "GPT-5.3", "GPT-5.4", "GPT-5.5", "GPT-5.6", "GPT-6 Astra"),
...
LATEST_PACKS = {
    ...
    "OpenAI": ("2609_GPT_6_Astra", "GPT-6 Astra", "1.05M context、异步工具、mid-turn steering 与跨 context 状态，面向高价值长时程 agent。", "https://developers.openai.com/api/docs/models/gpt-6-astra"),
}
...
DeepSeek、xAI、Mistral、Tencent Hunyuan、Amazon Nova、NVIDIA Nemotron、Cohere Command、IBM Granite、Microsoft Phi；并补齐 Anthropic Claude Fable 5.1、Google Gemini 3.8 Flash 与 OpenAI GPT-6 Astra 当前节点。
